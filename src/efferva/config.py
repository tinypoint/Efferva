...
class Settings(BaseSettings):
    ...
    codex_connection_ttl_seconds: int = 24 * 60 * 60
    codex_connection_queue_capacity: int = 10_000
    codex_frame_queue_capacity: int = 1_000
    codex_frame_max_bytes: int = 128 * 1024 * 1024
    codex_connection_lease_seconds: int = 30
    ...
    worker_connection_capacity: int = 16
    worker_connection_claim_idle_seconds: int = 45
