...
from agentframe.identity import IdentityResolver, Principal
from agentframe.models import (
    PrincipalView,
    Run,
    RunAgentInput,
    RunCreate,
...
from agentframe.repository import AuthorizedRepository, NotFoundError, SystemRepository
...
def principal_dependency(
    ...
    async def resolve(request: Request) -> Principal:
        ...
        if not isinstance(principal, Principal):
            raise TypeError("IdentityResolver must return agentframe.Principal")
        return principal
